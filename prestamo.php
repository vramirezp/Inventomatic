					...
					<div class="panel-body padding-0">
						<form class="form-horizontal" action="" method="POST" id="agregarProductoLista" enctype="multipart/form-data">
							...
							<div class="form-group">
								...
								<div class="col-xs-2"">
									<div class="btn-group" >
										<button type="submit" class="btn btn-primary" id="agregarLista">Agregar a Lista</button>
									</div>
								</div>
							</div>
						</form>
				...
				<div class="col-xs-4 padding-right-5">
				    ...
				    <div class="panel panel-default">
					  	<div class="panel-heading">
					    	<h3 class="panel-title">Detalle de Prestamo:</h3>
					 	</div>
					  	<div class="panel-body padding-20 padding-top-15 padding-bottom-15">
							...
							<div class="margin-top-10">
								...
								<div class="btn-group btn-group-justified">
									<div class="btn-group">
										<button type="button" class="btn btn-danger" id="cancelarC">Cancelar Prestamo</button>
									</div>
									<div class="btn-group">
										<button type="submit" class="btn btn-primary" id="guardar3">Terminar Prestamo</button>
									</div>
